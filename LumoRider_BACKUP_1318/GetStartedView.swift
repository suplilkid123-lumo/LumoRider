...
struct GetStartedView: View {
    ...
    // NEW: navigate to HomeView after Google login
    ...
    var body: some View {
        NavigationStack {
            ...
            // NEW: navigate to EmailAuthView when "Continue with Email" is tapped
    ...
    // MARK: - Send SMS code with Firebase
    private func sendCode() {
        ...
        print("☎️ sendCode() called with:", formatted)
        errorMessage = "Sending code..."
        isSending = true
            ...
            .verifyPhoneNumber(formatted, uiDelegate: nil) { verificationID, error in
                DispatchQueue.main.async {
                    ...
                    guard let verificationID = verificationID else {
                        print("⚠️ No verification ID returned")
                        self.errorMessage = "No verification ID returned."
                        return
                    }
                    ...
                    self.errorMessage = "Code sent. Opening verification screen..."
...
struct SocialButton: View {
    ...
    var body: some View {
        Button(action: action) {
            HStack(spacing: 12) {
                icon
                    .renderingMode(.template)      // <-- force template
                    .foregroundColor(.black)       // <-- make icon black
                    .font(.system(size: 20))
